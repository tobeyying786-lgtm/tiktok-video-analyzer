...
function renderTab2(shots) {
  ...
  shots.forEach((s, i) => {
    ...
    rows += '<tr>' +
      ...
      '</td>' +
      '<td style="text-align:center">' + (s.product_visible ? '<span class="c-green" style="font-weight:700">是</span>' : '') + '</td>' +
    '</tr>';
  });
  ...
  document.getElementById('t2').innerHTML =
    ...
    '<div style="overflow-x:auto">' +
      '<table class="sb-table" id="sb-table"><thead><tr>' +
        '<th>镜头</th><th>时间</th><th>类型</th><th>画面描述</th><th>截图</th><th>文案/口播</th><th>产品</th>' +
...
function copyTable() {
  ...
  b.textContent = '已复制'; setTimeout(() => b.textContent = '复制表格', 2000);
}
